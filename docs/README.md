...
2. **[`docs/upstream/`](upstream/README.md)**
   - 테제 계보([`blackan/claire_bible`](https://github.com/blackan/claire_bible))의 오리지널 기획, 설계 초안 및 연구 원본 자료입니다.
   - 프로젝트의 테제 비전과 공개 아키텍처 원본은 각각 [`GOALS.md`](upstream/GOALS.md)와 [`PLAN.md`](upstream/PLAN.md)입니다.
   - 증강 계보에서 기능을 고도화했더라도 별도 개정하지 않은 원천 테제는 이곳의 원본 문서를 단일 정본으로 참조합니다.
