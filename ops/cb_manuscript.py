...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  ./cb-manuscript preflight       # Pre-flight check configuration and environment\n"
            ...
            "  ./cb-manuscript app doctor      # Diagnose knowledge graph & DB integrity\n"
