...
def document_detail(
    ...
    return {
        ...
        "pdf_encoding_flaw_detected": bool(meta_dict.get("pdf_encoding_flaw_detected", False)),
        "pdf_encoding_flaws": meta_dict.get("pdf_encoding_flaws") or [],
        "pdf_is_scanned": bool(meta_dict.get("pdf_is_scanned", False)),
        ...
        "caption_language": meta_dict.get("caption_language"),
        "is_stt": is_stt,
